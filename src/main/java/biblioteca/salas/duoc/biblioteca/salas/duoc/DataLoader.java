    ...
    public class DataLoader implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                carrera.setCodigo_carrera(faker.code().asin());
            ...
            for (int i = 0; i < 50; i++) {
                ...
                estudiante.setId_estudiante(i + 1);
            ...
            for (int i = 0; i < 20; i++) {
                ...
                reserva.setId_reserva(i + 1);
                reserva.setEstudiantes(estudiantes.get(random.nextInt(estudiantes.size())));
